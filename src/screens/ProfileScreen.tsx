...
const styles = StyleSheet.create({
  ...
  // Header Style matching image_fcb356.png
  headerRow: { 
    flexDirection: 'row', 
    alignItems: 'center', 
    marginTop: 20, 
  ...
  backArrow: { 
    color: '#00d2ff', // Cyan color matching image_fcb356.png
    fontSize: 32, 
    fontWeight: 'bold' 
  },
  ...
  avatarLarge: { 
    ...
    backgroundColor: '#0c1a2b', justifyContent: 'center', 
    alignItems: 'center', borderWidth: 2, borderColor: '#00d2ff' 
  },
  changePhotoBtn: { marginTop: 15 },
  changePhotoText: { color: '#00d2ff', fontWeight: 'bold' },

  form: { marginBottom: 30 },
  label: { color: 'rgba(255,255,255,0.5)', fontSize: 12, marginBottom: 8, textTransform: 'uppercase' },
  input: { 
    backgroundColor: '#0c1a2b', borderRadius: 12, padding: 15, 
    color: '#fff', fontSize: 16, marginBottom: 20,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)'
  },

  saveBtn: { 
    backgroundColor: '#00d2ff', padding: 18, 
