...
const AI_RECOMMENDATIONS = [
  { 
    ...
    match: '98%', 
    reason: 'Because you attended "UI/UX Basics" and "Intro to JS"',
    location: 'IT Center - Lab 4',
    time: 'May 20, 09:00 AM'
  },
  { 
    id: '2', 
    title: 'Addis Tech Startup Pitch', 
    match: '85%', 
    reason: 'Matches your interest in Entrepreneurship events',
    location: 'Business School Hall',
    time: 'May 22, 02:00 PM'
  },
  { 
    id: '3', 
    title: 'Campus Photography Club Meetup', 
    match: '72%', 
    reason: 'Based on your recent search for Social events',
    location: 'Main Library Garden',
    time: 'May 25, 04:30 PM'
  },
];
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.aiCard}>
              ...
              >
                <LinearGradient
                  colors={registeredIds.includes(item.id) ? ['#28a745', '#1e7e34'] : ['#00d2ff', '#3a7bd5']}
                  style={styles.btnGradient}
                >
                  <Text style={styles.btnText}>
                    {registeredIds.includes(item.id) ? '✓ Joined' : 'Register Now'}
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  aiCard: {
    ...
    marginBottom: 20,
    borderWidth: 1,
    borderColor: 'rgba(142, 45, 226, 0.3)', // Slight purple border for AI feel
  },
  matchBadge: {
