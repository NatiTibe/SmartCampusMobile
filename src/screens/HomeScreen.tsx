        ...
        if (backendEvents.length > 0) {
          setEvents(
            backendEvents.map((ev: any) => ({
              ...
              registrationCount:
                ev.registrationCount || ev.registeredCount || 0,
              isRegistered: false,
              image:
                ev.imageUrl ||
                ev.image ||
  ...
  const [events, setEvents] = useState([
    {
      ...
      image:
        'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4',
      description:
        'A showcase of student innovation in AI and Robotics. Join us for networking!',
    },
    {
      id: '2',
      title: 'Film festival',
      category: 'Social',
      location: '6 Kilo campus',
      date: 'May 6',
      time: '03:00 PM',
      ...
      description:
        'Experience local student films and documentaries in an outdoor setting.',
    },
    {
      id: '3',
      ...
      description:
        'A beginner-friendly intensive coding session for Python enthusiasts.',
    },
  ]);
      ...
      prev.map((ev) =>
        ev.id === id
          ? {
              ...
              registrationCount: ev.isRegistered
      ...
      >
        ...
        >
          ...
          <Text style={styles.heroText}>
            You have {events.filter((e) => e.isRegistered).length}{' '}
            events coming up. Your AI-powered feed found new events
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('SubscribedEvents', {
                userSubscriptions,
              })
            }
          >
        ...
        {subscribedFeedEvents.length > 0 ? (
          ...
          <View style={styles.emptyFeed}>
            <Text style={styles.emptyText}>
              No specific matches found yet. Subscribe to your
              favorite categories!
            </Text>
          </View>
        )}
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('PopularExplore')}
          >
        ...
        {popularEvents.map((item) => (
          ...
          >
            ...
            <View style={styles.popularInfo}>
              <Text style={styles.popularCategory}>
                {item.category}
              </Text>
              ...
              <Text style={styles.popularMeta}>
                🔥 {item.registrationCount} students joined
              </Text>
            </View>
          </TouchableOpacity>
        ))}
